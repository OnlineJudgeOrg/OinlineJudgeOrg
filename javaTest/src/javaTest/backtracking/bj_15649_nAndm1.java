...
public class bj_15649_nAndm1 {
	...
	public static void main(String[] args) throws IOException {
		...
		boolean[] availableNumber = new boolean[n+1];
	...
	public static void dfs(int depth, int m, int n, boolean[] availableNumber, int[] resultNumber, int start) {
		if (depth == m) {
			// 출력
		...
		for(int i=start; i<availableNumber.length; i++) {
			...
			dfs(depth+1, m, n, availableNumber, resultNumber, i);
		}
	}
}
